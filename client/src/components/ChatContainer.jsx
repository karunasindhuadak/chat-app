        ...
        {messagesDummyData.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`mb-8 p-2 max-w-[200px] md:text-sm rounded-lg break-all bg-violet-500/30 font-light text-white ${msg.senderId === "680f50e4f10f3cd28382ecf9" ? "rounded-br-none" : "rounded-bl-none"}`}
              >
                {msg.text}
              </p>
            )}
